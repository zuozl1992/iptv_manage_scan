#include "scanner_stream_probe.h"
...
ScannerStreamProbe::ScannerStreamProbe(QObject *parent)
    : QThread(parent)
{
}

void ScannerStreamProbe::setUrl(const QString &url)
{
    m_url = url;
}

void ScannerStreamProbe::setTimeout(int ms)
{
    m_timeout = ms;
}

void ScannerStreamProbe::setSlowScan(bool enabled)
{
    m_slowScan = enabled;
}

void ScannerStreamProbe::run()
{
    if (m_url.isEmpty()) {
